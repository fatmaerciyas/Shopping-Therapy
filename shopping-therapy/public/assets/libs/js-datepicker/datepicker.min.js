    ...
    function (e, t, n) {
      ...
      function u(e, t) {
        var n = e.calendar.querySelector(".qs-overlay"),
          a = n && !n.classNameNameList.contains("qs-hidden");
      ...
      function h(e, t, n) {
        return [
          '<div classNameName="qs-controls' + (n ? " qs-blur" : "") + '">',
          '<div classNameName="qs-arrow qs-left"></div>',
          '<div classNameName="qs-month-year' +
            (t.disableYearOverlay ? " qs-disabled-year-overlay" : "") +
            '">',
          '<span classNameName="qs-month">' +
            t.months[e.getMonth()] +
            "</span>",
          '<span classNameName="qs-year">' + e.getFullYear() + "</span>",
          "</div>",
          '<div classNameName="qs-arrow qs-right"></div>',
          "</div>",
        ].join("");
      }
      function f(e, t, n) {
        ...
        var R = d
          .map(function (e) {
            return '<div classNameName="qs-square qs-day">' + e + "</div>";
          })
          .concat(q);
        return (
          R.unshift(
            '<div classNameName="qs-squares' + (n ? " qs-blur" : "") + '">'
          ),
          R.push("</div>"),
          R.join("")
        );
      ...
      function v(e, t) {
        var n = e.overlayPlaceholder,
          a = e.overlayButton;
        return [
          '<div classNameName="qs-overlay' + (t ? "" : " qs-hidden") + '">',
          "<div>",
          '<input classNameName="qs-overlay-year" placeholder="' +
            n +
            '" inputmode="numeric" />',
          '<div classNameName="qs-close">&#10005;</div>',
          "</div>",
          '<div classNameName="qs-overlay-month-container">' +
            e.overlayMonths
              .map(function (e, t) {
                return (
                  '<div classNameName="qs-overlay-month" data-month-num="' +
                  t +
                  '">' +
                  e +
                  "</div>"
              ...
              .join("") +
            "</div>",
          '<div classNameName="qs-submit qs-disabled">' + a + "</div>",
          "</div>",
        ].join("");
      }
      function m(e, t, n) {
        ...
        ((a.disabled || a.readOnly) && t.respectDisabledReadOnly) ||
          ...
          r && r.classNameNameList.remove("qs-active"),
          n || e.classNameNameList.add("qs-active"),
          p(a, t, n),
          n || q(t),
          o &&
      ...
      function D(e) {
        if (!e.noPosition) {
          ...
          if (e.position.centered)
            return e.calendarContainer.classNameNameList.add("qs-centered");
      ...
      function q(e) {
        e.disabled ||
          (!e.calendarContainer.classNameNameList.contains("qs-hidden") &&
            !e.alwaysShow &&
            ("overlay" !== e.defaultView && M(!0, e),
            e.calendarContainer.classNameNameList.add("qs-hidden"),
            e.onHide(e)));
      }
      function S(e) {
        e.disabled ||
          (e.calendarContainer.classNameNameList.remove("qs-hidden"),
      ...
      function M(e, t) {
        ...
        e
          ? (a.classNameNameList.add("qs-hidden"),
            i.classNameNameList.remove("qs-blur"),
            o.classNameNameList.remove("qs-blur"),
            (r.value = ""))
          : (a.classNameNameList.remove("qs-hidden"),
            i.classNameNameList.add("qs-blur"),
            o.classNameNameList.add("qs-blur"),
            r.focus());
      }
      function E(e, t, n, a) {
        ...
        if (13 === e.which || 13 === e.keyCode || "click" === e.type)
          a
            ? w(null, n, i, a)
            : r || t.classNameNameList.contains("qs-disabled") || w(null, n, i);
        else if (n.calendar.contains(t)) {
          n.calendar
            .querySelector(".qs-submit")
            .classNameNameList[r ? "add" : "remove"]("qs-disabled");
        }
      }
      function x(e) {
        ...
        if (!e.__qs_shadow_dom) {
          ...
          if (!(s && s.isMobile && s.disableMobile))
            if ("click" === n) {
              ...
              if (s.noPosition && !l)
                (c.classNameNameList.contains("qs-hidden") ? S : q)(s);
                ...
                if (o.contains("qs-num")) {
                  ...
                  return void (+x == +s.dateSelected
                    ? m(r, s, !0)
                    : r.classNameNameList.contains("qs-disabled") || m(r, s));
                }
              ...
              var P = !s.calendar
                ...
                .classNameNameList.contains("qs-hidden");
              ...
              var k = s.calendar.querySelector(".qs-submit"),
                N = r.value
                  ...
                  .slice(0, 4);
              (r.value = N),
                k.classNameNameList[4 === N.length ? "remove" : "add"](
                  "qs-disabled"
                );
            }
        }
      ...
      function B() {
        var e = !this.calendarContainer.classNameNameList.contains("qs-hidden"),
      ...
      t.default = function (e, t) {
        var n = (function (e, t) {
          ...
          (D.classNameNameName = "qs-datepicker-container qs-hidden"),
            (q.classNameNameName = "qs-datepicker");
          var M = {
            shadowDom: n,
            customElement: l,
            positionedEl: w,
