var tns = (function () {
  ...
  var i = "classNameNameList" in document.createElement("_"),
    Pi = i
      ? function (t, e) {
          return t.classNameNameList.contains(e);
        }
      : function (t, e) {
          return 0 <= t.classNameNameName.indexOf(e);
        },
    zi = i
      ? function (t, e) {
          Pi(t, e) || t.classNameNameList.add(e);
        }
      : function (t, e) {
          Pi(t, e) || (t.classNameNameName += " " + e);
        },
    Wi = i
      ? function (t, e) {
          Pi(t, e) && t.classNameNameList.remove(e);
        }
      : function (t, e) {
          Pi(t, e) &&
            (t.classNameNameName = t.classNameNameName.replace(e, ""));
        };
  function qi(t, e) {
  ...
  var $i = function (H) {
        ...
        : Si(
            ...
            (function () {
              var t,
                ...
                o = "";
              (a.classNameNameName = "tns-t-subp2"),
                (r.classNameNameName = "tns-t-ct");
      ...
      D = e.tMQ
        ...
        : Si(
            ...
            (function () {
              ...
              return (
                (r.type = "text/css"),
                (a.classNameNameName = "tns-mq-test"),
                n.appendChild(r),
                n.appendChild(a),
                r.styleSheet
    ...
    if (
      ...
      var M,
        ...
        X = rn(),
        Y = !1;
      k && En(), I && (V.classNameNameName += " tns-vpfix");
      var N,
        L,
        B,
        S,
      ...
      if (se)
        var Ie,
          ...
          Ge = [
            "<span classNameName='tns-visually-hidden'>",
            " animation</span>",
          ];
      if (ce || fe)
        var Qe,
      ...
      $ || $e(Kt || _t),
        r &&
          ...
          o
            ...
            : ((Dt += F ? "X(" : "Y("), (kt = ")"))),
        I &&
          (V.classNameNameName = V.classNameNameName.replace("tns-vpfix", "")),
        (function () {
          ln("gutter");
          (T.classNameNameName = "tns-outer"),
            (j.classNameNameName = "tns-inner"),
            (T.id = Yt + "-ow"),
            (j.id = Yt + "-iw"),
            "" === V.id && (V.id = Yt);
          (Xt += g || $ ? " tns-subpixel" : " tns-no-subpixel"),
            ...
            $ && (Xt += " tns-autowidth");
          (Xt += " tns-" + H.axis),
            (V.classNameNameName += Xt),
            I
              ? (((M = O.createElement("div")).id = Yt + "-mw"),
                (M.classNameNameName = "tns-ovh"),
                T.appendChild(M),
                M.appendChild(j))
              : T.appendChild(j);
          if (dt) {
            var t = M || j;
            t.classNameNameName += " tns-ah";
          }
          if (
            (E.insertBefore(T, V),
            j.appendChild(V),
    ...
    function bn() {
      if (
        ...
        T.insertAdjacentHTML(
          "afterbegin",
          '<div classNameName="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span classNameName="current">' +
            Hn() +
            "</span>  of " +
            Q +
            "</div>"
        ...
        if (Ae)
          ...
          for (
            ...
            e +=
              ...
              '"></button>';
          (e =
            '<div classNameName="tns-nav" aria-label="Carousel Pagination">' +
            e +
            "</div>"),
      ...
      oe &&
        (xe ||
          ...
          (T.insertAdjacentHTML(
            ...
            '<div classNameName="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' +
              Yt +
              '">' +
              pt[0] +
          ...
          e &&
            ...
            (Kt
              ...
              : (function () {
                  if (!Jt) return;
                  if (
                    ((Mt.disabled = !1), (V.classNameNameName += Xt), $n(), ft)
                  )
    ...
    function Bn() {
      if (!Jt) {
        if (
          ((Mt.disabled = !0),
          (V.classNameNameName = V.classNameNameName.replace(
            Xt.substring(1),
            ""
          )),
          Vi(V, ["style"]),
