                    ...
                    >
                      <nav className="flex-1 space-y-2 bg-white">
                        <a
                          ...
                          className="flex h-11 p-2 w-full text-purple-800  rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        >
                          <svg
                            className="h-7 w-7"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a
                          ...
                          className="flex h-11 p-2 w-full text-blue-700  rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        >
                          <svg
                            className="h-7 w-7"
                            viewBox="0 0 24 24"
                        ...
                        >
                          ...
                          {isOpen && (
                            <span className="text-black mt-2  px-4">Users</span>
                          )}
                        </a>
                        <a
                        ...
                        <a
                          onClick={() =>
                            handleClick(PATH_DASHBOARD.updateMyProfile)
                          }
                          className="flex h-11 p-2 w-full text-blue-700  rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        >
                          <svg
