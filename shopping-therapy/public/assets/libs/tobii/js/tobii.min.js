(function (a, b) {
  ...
  return function (a) {
        ...
        image: {
          ...
          init: function (a, b) {
            ...
            (d.style.opacity = "0"),
              ...
              d.appendChild(g),
              c.captions &&
                ("self" === c.captionsSelector &&
                a.getAttribute(c.captionAttribute)
                ...
                f.textContent &&
                  ...
                  ++e)),
              b.appendChild(d),
              (i.classNameNameName = "tobii-loader"),
    ...
    var E = function (a) {
        ...
        if (!b)
          throw new Error("Ups, I can't find the selector " + c.selector + ".");
      ...
      G = function (a) {
        return a.hasAttribute("data-group")
          ? a.getAttribute("data-group")
          : "default";
      },
      H = function (a) {
      ...
      I = function (a, b) {
        if (
          ...
          if (
            (z[A].gallery.push(a),
            z[A].elementsLength++,
            c.zoom && a.querySelector("img"))
          ) {
            var d = document.createElement("div");
            (d.classNameNameName = "tobii-zoom__icon"),
              (d.innerHTML = c.zoomText),
              a.classNameNameList.add("tobii-zoom"),
              a.appendChild(d);
          }
      ...
      J = function (a, b) {
        ...
        if (-1 === z[d].gallery.indexOf(a));
          ...
          if (
            (z[d].elementsLength--,
            c.zoom && a.querySelector(".tobii-zoom__icon"))
          ) {
            var g = a.querySelector(".tobii-zoom__icon");
            g.parentNode.classNameNameList.remove("tobii-zoom"),
      ...
      M = function (a) {
        for (var b in D)
          if (
            ...
            (c.classNameNameName = "tobii__slider-slide"),
      ...
      N = function (a, b) {
        if (((B = null === B ? A : B), ra() || a || (a = 0), ra())) {
          ...
          if (a === z[B].currentIndex)
            throw new Error("Ups, slide " + a + " is already selected.");
        }
        if (-1 === a || a >= z[B].elementsLength)
          throw new Error("Ups, I can't find slide " + a + ".");
        c.hideScrollbar &&
          (document.documentElement.classNameNameList.add("tobii-is-open"),
          document.body.classNameNameList.add("tobii-is-open")),
          na(),
          ...
          P(z[B].currentIndex - 1),
          setTimeout(function () {
            z[B].slider.classNameNameList.add("tobii__slider--animate");
          }, 1e3),
          b && b.call(this);
      },
      O = function (a) {
        ...
        c.hideScrollbar &&
          (document.documentElement.classNameNameList.remove("tobii-is-open"),
          document.body.classNameNameList.remove("tobii-is-open")),
          ka(),
          o.focus();
        var b =
            z[B].sliderElements[z[B].currentIndex].querySelector("[data-type]"),
          d = b.getAttribute("data-type");
        D[d].onLeave(b),
          D[d].onCleanup(b),
          f.setAttribute("aria-hidden", "true"),
          (z[B].currentIndex = 0),
          z[B].slider.classNameNameList.remove("tobii__slider--animate"),
          a && a.call(this);
      },
      P = function (a) {
      ...
      aa = function (a) {
        a.target === g
          ...
          ? S()
          : (a.target === i ||
              ("tobii__slider-slide" === a.target.classNameNameName &&
                c.docClose)) &&
            O(),
          a.stopPropagation();
      },
      ba = function (a) {
        9 === a.keyCode || "Tab" === a.code
          ...
          ? (a.preventDefault(), R())
          : (39 === a.keyCode || "ArrowRight" === a.code) &&
            (a.preventDefault(), S());
      },
      ca = function (a) {
        ta(a.target) ||
          ...
          z[B].slider.classNameNameList.add("tobii__slider--is-dragging"));
      },
      da = function (a) {
        a.stopPropagation(),
          n &&
            (a.preventDefault(),
            (k.endX = a.touches[0].pageX),
            (k.endY = a.touches[0].pageY),
            ia());
      },
      ea = function (a) {
        a.stopPropagation(),
          (n = !1),
          z[B].slider.classNameNameList.remove("tobii__slider--is-dragging"),
          k.endX && ((l = !1), (m = !1), Z()),
          Y();
      },
      fa = function (a) {
      ...
      na = function () {
        c.draggable &&
          1 < z[B].elementsLength &&
          !z[B].slider.classNameNameList.contains(
            "tobii__slider--is-draggable"
          ) &&
          z[B].slider.classNameNameList.add("tobii__slider--is-draggable"),
      ...
      ta = function (a) {
        return (
          -1 !==
            ["TEXTAREA", "OPTION", "INPUT", "SELECT"].indexOf(a.nodeName) ||
          a === g ||
          a === h ||
          a === i ||
          1 === z[B].elementsLength
