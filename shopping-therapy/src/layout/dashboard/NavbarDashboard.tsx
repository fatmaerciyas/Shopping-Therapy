  ...
  return (
    <>
      ...
      <div className="sidebar  rounded-xl print:hidden">
        <div className="main-sidebar rounded-xl mt-16 ">
          <div className="flex h-full rounded-xl w-full flex-col items-center border-r  border-gray-200 bg-white dark:border-navy-700 dark:bg-navy-800">
            <div className=" flex  items-center flex-col space-y-4 pt-6  ">
              <a
                ...
                className="flex h-11 w-11 text-purple-800  items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
                  className="h-7 w-7"
              ...
              <a
                ...
                className="flex  text-blue-700 h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
                  className="h-7 w-7"
                  viewBox="0 0 24 24"
              ...
              <a
                onClick={() => handleClick(PATH_DASHBOARD.productManagement)}
                className="flex  text-blue-700 h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
                  className="h-7 w-7"
              ...
              <a
                onClick={() => handleClick(PATH_DASHBOARD.cargoManagement)}
                className="flex  text-blue-700 h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
                  className="h-7 w-7"
              ...
              <a
                ...
                className="flex h-11 w-11  text-purple-800  items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90"
              >
                <svg
                  className="h-7 w-7"
                  viewBox="0 0 24 24"
