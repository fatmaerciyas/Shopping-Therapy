      ...
      var e = {
        ...
        l = function (t, e) {
          if (e.nested && t.parentNode) {
            ...
            n && (n.classNameNameList.remove(e.nestedclassNameName), l(n, e));
          }
        },
        a = function (t, e) {
          if (t) {
            ...
            o &&
              (o.classNameNameList.remove(e.navclassNameName),
              t.content.classNameNameList.remove(e.contentclassNameName),
              l(o, e),
        ...
        u = function (t, e) {
          if (e.nested) {
            var n = t.parentNode.closest("li");
            n && (n.classNameNameList.add(e.nestedclassNameName), u(n, e));
          }
        };
      return function (o, r) {
        var c,
              ...
              ? (f && t.content === f.content) ||
                ...
                (function (t, e) {
                  if (t) {
                    var o = t.nav.closest("li");
                    o &&
                      (o.classNameNameList.add(e.navclassNameName),
                      t.content.classNameNameList.add(e.contentclassNameName),
                      u(o, e),
                      n("gumshoeActivate", o, {
                        link: t.nav,
                        content: t.content,
