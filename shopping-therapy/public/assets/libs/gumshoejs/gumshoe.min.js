...
!(function (e, t) {
  ...
  function (e) {
    "use strict";
    var t = {
        navclassNameName: "active",
        contentclassNameName: "active",
        nested: !1,
        nestedclassNameName: "active",
        offset: 0,
        reflow: !1,
        events: !0,
      },
      ...
      a = function (e, t) {
        if (t.nested && e.parentNode) {
          ...
          n && (n.classNameNameList.remove(t.nestedclassNameName), a(n, t));
        }
      },
      l = function (e, t) {
        if (e) {
          ...
          o &&
            (o.classNameNameList.remove(t.navclassNameName),
            e.content.classNameNameList.remove(t.contentclassNameName),
            a(o, t),
      ...
      u = function (e, t) {
        if (t.nested) {
          var n = e.parentNode.closest("li");
          n && (n.classNameNameList.add(t.nestedclassNameName), u(n, t));
        }
      };
    return function (o, c) {
      var i,
            ...
            ? (f && e.content === f.content) ||
              ...
              (function (e, t) {
                if (e) {
                  var o = e.nav.closest("li");
                  o &&
                    (o.classNameNameList.add(t.navclassNameName),
                    e.content.classNameNameList.add(t.contentclassNameName),
                    u(o, t),
                    n("gumshoeActivate", o, {
                      link: e.nav,
                      content: e.content,
